...
const Skills = () => {
  ...
  return (
    <div className="Skills flex flex-col gap-16 justify-center items-center text-center relative">
      <h1 className="z-10 text-[#B7A7FD] text-5xl font-bold ">My Skills</h1>
      ...
      <Image src={"/Group 1910 1.svg"} alt="universe" width={100} height={100} className="w-4xl -mt-55"/>
    </div>
  );
};
